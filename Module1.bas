...
Sub シート目次()
    ...
    For i = 2 To Worksheets.Count Step 1
        ...
        If Worksheets(i).Visible = xlSheetVisible Then
            ...
            Worksheets(i).Hyperlinks.Add Anchor:=Worksheets(i).Cells(4, 10), Address:="\\192.168.10.252\share\データ保管(東山）\テスト\組合員別所有船.xlsm", SubAddress:=Kumimei & "!A1", TextToDisplay:="漁船登録", ScreenTip:=Worksheets(i).Cells(4, 10).Text
            'ワークシート名を格納
