            ...
            If .Worksheets(i).Visible = xlSheetVisible Then
                ...
                For h = 15 To 3 Step -1
                    If Not .Worksheets(i).Cells(6, h).Value = "" Then
                        ...
                        .Worksheets(i).Hyperlinks.Add Anchor:=.Worksheets(i).Cells(6, h), Address:="\\192.168.10.252\share\データ保管(東山）\テスト\組合員別所有船.xlsm", SubAddress:=Kumimei & "!A1", TextToDisplay:=.Worksheets(i).Cells(6, h).Text, ScreenTip:=.Worksheets(i).Cells(6, h).Text
'                        GoTo EndLoop0
                    End If
                Next
EndLoop0:
